; MFGTEST.EXE - MS-DOS MZ executable extracted from LT300/UT200 ROM
; image 6090 B, header 512 B (32 paragraphs)
; entry CS:IP = 0x0000:0x0000  SS:SP = 0x015d:0x0400
; 5 relocations: 0x0000:0x0002, 0x0000:0x1115, 0x0000:0x1142, 0x0000:0x1211, 0x0000:0x1283
; load module disassembled below (origin = CS base 0x0); >>> marks entry point
;
; --- MZ header (512 bytes) ---
; 0000  4d 5a ca 01 0c 00 05 00 20 00 41 00 ff ff 5d 01  MZ...... .A...].
; 0010  00 04 b2 be 00 00 00 00 1e 00 00 00 01 00 02 00  ................
; 0020  00 00 15 11 00 00 42 11 00 00 11 12 00 00 83 12  ......B.........
...
>>> 00000000  1E                push ds
    ...
    0000134C  3031              xor [bx+di],dh
    0000134E  3032              xor [bp+si],dh
    00001350  3033              xor [bp+di],dh
    00001352  3034              xor [si],dh
    00001354  3035              xor [di],dh
    00001356  3430              xor al,0x30
    00001358  3431              xor al,0x31
    0000135A  2020              and [bx+si],ah
    0000135C  2020              and [bx+si],ah
    0000135E  2020              and [bx+si],ah
    00001360  2020              and [bx+si],ah
    00001362  2020              and [bx+si],ah
    00001364  2020              and [bx+si],ah
    00001366  2020              and [bx+si],ah
    00001368  2020              and [bx+si],ah
    0000136A  0000              add [bx+si],al
    0000136C  32363237          xor dh,[0x3732]
    00001370  3238              xor bh,[bx+si]
    00001372  3432              xor al,0x32
    00001374  3433              xor al,0x33
    00001376  3434              xor al,0x34
    00001378  3435              xor al,0x35
    ...
    0000138C  3436              xor al,0x36
    0000138E  3437              xor al,0x37
    00001390  3438              xor al,0x38
    00001392  3439              xor al,0x39
    00001394  353035            xor ax,0x3530
    00001397  3120              xor [bx+si],sp
    00001399  2020              and [bx+si],ah
    0000139B  2020              and [bx+si],ah
    0000139D  2020              and [bx+si],ah
    0000139F  2020              and [bx+si],ah
    000013A1  2020              and [bx+si],ah
    000013A3  2020              and [bx+si],ah
    000013A5  2020              and [bx+si],ah
    000013A7  2020              and [bx+si],ah
    000013A9  2000              and [bx+si],al
    000013AB  0031              add [bx+di],dh
    000013AD  3030              xor [bx+si],dh
    000013AF  3930              cmp [bx+si],si
    000013B1  3830              cmp [bx+si],dh
    000013B3  37                aaa
    000013B4  353930            xor ax,0x3039
    000013B7  363131            xor [ss:bx+di],si
    000013BA  3132              xor [bp+si],si
    000013BC  3133              xor [bp+di],si
    000013BE  3134              xor [si],si
    000013C0  2020              and [bx+si],ah
    000013C2  2020              and [bx+si],ah
    000013C4  2020              and [bx+si],ah
    000013C6  2020              and [bx+si],ah
    000013C8  2020              and [bx+si],ah
    000013CA  0000              add [bx+si],al
    000013CC  3135              xor [di],si
    000013CE  31363137          xor [0x3731],si
    000013D2  3138              xor [bx+si],di
    000013D4  3139              xor [bx+di],di
    000013D6  3230              xor dh,[bx+si]
    000013D8  3231              xor dh,[bx+di]
    000013DA  3232              xor dh,[bp+si]
    000013DC  3233              xor dh,[bp+di]
    000013DE  3234              xor dh,[si]
    000013E0  3235              xor dh,[di]
    ...
    000013EC  3239              xor bh,[bx+di]
    000013EE  3330              xor si,[bx+si]
    000013F0  2020              and [bx+si],ah
    000013F2  2020              and [bx+si],ah
    000013F4  2020              and [bx+si],ah
    000013F6  2020              and [bx+si],ah
    000013F8  2020              and [bx+si],ah
    000013FA  2020              and [bx+si],ah
    ...
    00001408  2020              and [bx+si],ah
    0000140A  0000              add [bx+si],al
    0000140C  3331              xor si,[bx+di]
    0000140E  3332              xor si,[bp+si]
    00001410  3333              xor si,[bp+di]
    00001412  3334              xor si,[si]
    00001414  3335              xor si,[di]
    00001416  33363337          xor si,[0x3733]
    0000141A  3338              xor di,[bx+si]
    0000141C  3339              xor di,[bx+di]
    0000141E  2020              and [bx+si],ah
    00001420  2020              and [bx+si],ah
    00001422  2020              and [bx+si],ah
    00001424  2020              and [bx+si],ah
    00001426  2020              and [bx+si],ah
    00001428  2020              and [bx+si],ah
    0000142A  0000              add [bx+si],al
    0000142C  353235            xor ax,0x3532
    0000142F  3335              xor si,[di]
    00001431  3435              xor al,0x35
    00001433  353536            xor ax,0x3635
    00001436  353735            xor ax,0x3537
    00001439  3820              cmp [bx+si],ah
    0000143B  2020              and [bx+si],ah
    0000143D  2020              and [bx+si],ah
    0000143F  2020              and [bx+si],ah
    00001441  2020              and [bx+si],ah
    00001443  2020              and [bx+si],ah
    00001445  2020              and [bx+si],ah
    00001447  2020              and [bx+si],ah
    00001449  2000              and [bx+si],al
    0000144B  00363020          add [0x2030],dh
    0000144F  2020              and [bx+si],ah
    00001451  2020              and [bx+si],ah
    00001453  2020              and [bx+si],ah
    00001455  2020              and [bx+si],ah
    00001457  2020              and [bx+si],ah
    00001459  2020              and [bx+si],ah
    0000145B  2020              and [bx+si],ah
    0000145D  2020              and [bx+si],ah
    0000145F  2020              and [bx+si],ah
    00001461  2020              and [bx+si],ah
    00001463  2020              and [bx+si],ah
    00001465  2020              and [bx+si],ah
    00001467  2020              and [bx+si],ah
    00001469  2000              and [bx+si],al
    0000146B  0000              add [bx+si],al
    0000146D  0000              add [bx+si],al
    0000146F  0030              add [bx+si],dh
    00001471  000C              add [si],cl
    00001473  0008              add [bx+si],cl
    00001475  0008              add [bx+si],cl
    00001477  0002              add [bp+si],al
    00001479  004F1D            add [bx+0x1d],cl
    0000147C  004E00            add [bp+0x0],cl
    0000147F  3C20              cmp al,0x20
    00001481  363020            xor [ss:bx+si],ah
    00001484  48                dec ax
    00001485  7A20              jpe 0x14a7
    00001487  2020              and [bx+si],ah
    00001489  2020              and [bx+si],ah
    0000148B  2020              and [bx+si],ah
    0000148D  37                aaa
    0000148E  3220              xor ah,[bx+si]
    00001490  48                dec ax
    00001491  7A20              jpe 0x14b3
    00001493  41                inc cx
    00001494  54                push sp
    00001495  54                push sp
    00001496  52                push dx
    ...
    0000149B  45                inc bp
    0000149C  53                push bx
    0000149D  646220            bound sp,[fs:bx+si]
    000014A0  7170              jno 0x1512
    000014A2  206462            and [si+0x62],ah
    000014A5  207170            and [bx+di+0x70],dh
    000014A8  206462            and [si+0x62],ah
    000014AB  49                dec cx
    000014AC  44                inc sp
    000014AD  45                inc bp
    000014AE  4E                dec si
    ...
    000014BA  41                inc cx
    000014BB  4E                dec si
    000014BC  204164            and [bx+di+0x64],al
    000014BF  647265            fs jc 0x1527
    000014C2  7373              jnc 0x1537
    000014C4  3A30              cmp dh,[bx+si]
    000014C6  3132              xor [bp+si],si
    000014C8  3334              xor si,[si]
    000014CA  353637            xor ax,0x3736
    000014CD  3839              cmp [bx+di],bh
    000014CF  41                inc cx
    000014D0  42                inc dx
    000014D1  43                inc bx
    000014D2  44                inc sp
    ...
    000014D5  55                push bp
    000014D6  54                push sp
    000014D7  3230              xor dh,[bx+si]
    000014D9  302D              xor [di],ch
    000014DB  3220              xor ah,[bx+si]
    000014DD  302E3030          xor [0x3030],ch
    000014E1  3030              xor [bx+si],dh
    000014E3  382F              cmp [bx],ch
    000014E5  3331              xor si,[bx+di]
    000014E7  2F                das
    000014E8  3933              cmp [bp+di],si
    000014EA  205858            and [bx+si+0x58],bl
    000014ED  58                pop ax
    000014EE  58                pop ax
    ...
    00001527  EE                out dx,al
    00001528  EE                out dx,al
    00001529  EE                out dx,al
    0000152A  EE                out dx,al
    0000152B  EE                out dx,al
    0000152C  EE                out dx,al
    0000152D  EE                out dx,al
    0000152E  EE                out dx,al
    0000152F  EE                out dx,al
    00001530  EE                out dx,al
    00001531  EE                out dx,al
    00001532  EE                out dx,al
    00001533  EE                out dx,al
    00001534  EE                out dx,al
    00001535  EE                out dx,al
    00001536  EE                out dx,al
    00001537  EE                out dx,al
    00001538  EE                out dx,al
    00001539  EE                out dx,al
    0000153A  EE                out dx,al
    0000153B  EE                out dx,al
    0000153C  EE                out dx,al
    0000153D  EE                out dx,al
    0000153E  EE                out dx,al
    0000153F  EE                out dx,al
    00001540  EE                out dx,al
    00001541  EE                out dx,al
    00001542  EE                out dx,al
    00001543  EE                out dx,al
    00001544  EE                out dx,al
    00001545  EE                out dx,al
    00001546  EE                out dx,al
    00001547  EE                out dx,al
    00001548  EE                out dx,al
    00001549  EE                out dx,al
    0000154A  EE                out dx,al
    0000154B  EE                out dx,al
    0000154C  EE                out dx,al
    0000154D  EE                out dx,al
    0000154E  EE                out dx,al
    0000154F  EE                out dx,al
    00001550  EE                out dx,al
    00001551  EE                out dx,al
    00001552  EE                out dx,al
    00001553  EE                out dx,al
    00001554  EE                out dx,al
    00001555  EE                out dx,al
    00001556  EE                out dx,al
    00001557  EE                out dx,al
    00001558  EE                out dx,al
    00001559  EE                out dx,al
    0000155A  EE                out dx,al
    0000155B  EE                out dx,al
    0000155C  EE                out dx,al
    0000155D  0000              add [bx+si],al
    0000155F  EE                out dx,al
    00001560  EE                out dx,al
    00001561  EE                out dx,al
    00001562  EE                out dx,al
    00001563  EE                out dx,al
    00001564  EE                out dx,al
    00001565  EE                out dx,al
    00001566  EE                out dx,al
    00001567  EE                out dx,al
    00001568  EE                out dx,al
    00001569  EE                out dx,al
    0000156A  EE                out dx,al
    0000156B  EE                out dx,al
    0000156C  EE                out dx,al
    0000156D  EE                out dx,al
    0000156E  EE                out dx,al
    0000156F  EE                out dx,al
    00001570  EE                out dx,al
    00001571  EE                out dx,al
    00001572  EE                out dx,al
    00001573  EE                out dx,al
    00001574  EE                out dx,al
    00001575  EE                out dx,al
    00001576  EE                out dx,al
    00001577  EE                out dx,al
    00001578  EE                out dx,al
    00001579  EE                out dx,al
    0000157A  EE                out dx,al
    0000157B  EE                out dx,al
    0000157C  EE                out dx,al
    0000157D  EE                out dx,al
    0000157E  EE                out dx,al
    0000157F  EE                out dx,al
    00001580  EE                out dx,al
    00001581  EE                out dx,al
    00001582  EE                out dx,al
    00001583  EE                out dx,al
    00001584  EE                out dx,al
    00001585  EE                out dx,al
    00001586  EE                out dx,al
    00001587  EE                out dx,al
    00001588  EE                out dx,al
    00001589  EE                out dx,al
    0000158A  EE                out dx,al
    0000158B  EE                out dx,al
    0000158C  EE                out dx,al
    0000158D  EE                out dx,al
    0000158E  EE                out dx,al
    0000158F  EE                out dx,al
    00001590  EE                out dx,al
    00001591  EE                out dx,al
    00001592  EE                out dx,al
    00001593  EE                out dx,al
    00001594  EE                out dx,al
